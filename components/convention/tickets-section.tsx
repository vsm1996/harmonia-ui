...
const TIERS = [
  {
    ...
    price: 75,
    description: {
      full: "You get in. That's it. That's good.",
      short: "Gets you in",
    },
    features: {
      full: [
        "3 days, all public areas",
        "Artist alley & vendors",
        "Panels (regular seating)",
        "All screenings",
      ],
  ...
  },
  {
    ...
    price: 175,
    description: {
      full: "Skip some lines. Get some stuff.",
      short: "Skip lines, get stuff",
    },
    features: {
      full: [
        "Everything above +",
        "Front-ish panel seating",
        "Merch pack (worth ~$80)",
        "In 1 hour early each day",
        "Premium lounge (has AC)",
      ],
      short: ["General +", "Priority seating", "Free merch"],
    },
    highlight: true,
  },
  {
    ...
    price: 350,
    description: {
      full: "You want the whole thing? Here.",
      short: "The whole thing",
    },
    features: {
      full: [
        "Everything above +",
        "Actual front row at panels",
        "Meet the guests. Shake hands.",
        "VIP-only events (yes plural)",
        "Signed Gachiakuta print",
        "Someone to help you find stuff",
      ],
      short: ["Premium +", "Meet guests", "VIP events"],
    },
    highlight: false,
  },
] as const
...
const HEADERS = {
  full: {
    title: "Money Part",
    description: "Early bird ends July 1. After that, prices go up $25 across the board. We warned you.",
    footer: "Refunds til 30 days before. After that, no. Transfer to a friend if you need to bail.",
  },
  reduced: {
    title: "Tickets",
