...
const CAPACITY_PRESETS = {
  exhausted: {
    label: "Exhausted",
    description: "Barely functional. Show only essentials.",
    cognitive: 0.1,
    temporal: 0.1,
    emotional: 0.1,
    valence: -0.6,
  ...
  overwhelmed: {
    label: "Overwhelmed",
    description: "High stress. Simplify everything.",
    cognitive: 0.25,
    temporal: 0.2,
    emotional: 0.15,
    valence: -0.4,
  ...
  distracted: {
    label: "Distracted",
    description: "Limited focus, short attention span",
    cognitive: 0.4,
    temporal: 0.3,
    emotional: 0.5,
    valence: 0.0,
  ...
  exploring: {
    label: "Exploring",
    description: "Maximum everything. Unleash the UI.",
    cognitive: 1.0,
    temporal: 1.0,
    emotional: 1.0,
    valence: 0.8,
